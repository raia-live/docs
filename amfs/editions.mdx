---
title: "OSS vs SaaS"
description: "What's in SenseLab's Agent Memory File System (AMFS) open-source vs. AMFS SaaS — and when you need which."
icon: "scale-balanced"
---
...
**Ops (hosted):** read-like calls typically **1 op**, writes **2 ops**, `commit_outcome` **0 ops**.
