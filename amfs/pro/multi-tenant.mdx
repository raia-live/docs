...
description: "Run SenseLab as a hosted service with account isolation, RBAC, scoped API keys, and audit logging."
icon: "building"
---

# Multi-Tenant SaaS Foundation

The foundation for running SenseLab as a hosted service. Every API request is authenticated, authorized, scoped, and audited.

## Account Isolation

SenseLab Security enforces hard isolation between tenants at the storage layer, below the application. Company A cannot see Company B's data, even if there's a bug in application code.
