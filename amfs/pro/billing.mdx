...
This page describes the **contract** between the open-source **SenseLab HTTP API / MCP server** and the proprietary **control plane** (`amfs-internal`) that records usage and enforces quotas on SenseLab Cloud.
...
- [Connect to SenseLab](/amfs/getting-started/saas-connection) — API keys and `AMFS_HTTP_URL`
