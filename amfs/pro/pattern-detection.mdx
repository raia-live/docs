...
Features: severity filtering, entity-path scoping, cooldown-based suppression (prevent alert fatigue), and callback registration so you can route alerts wherever you already handle them.
