...
You can also ask us to revoke a connection for you at [privacy@sense-lab.ai](mailto:privacy@sense-lab.ai), which is useful if you have lost access to the app that holds it.
...
Something not covered here: [support@sense-lab.ai](mailto:support@sense-lab.ai). Security reports: [security@sense-lab.ai](mailto:security@sense-lab.ai).
