...
description: "Use SenseLab with CrewAI, LangGraph, LangChain, and AutoGen."
icon: "puzzle-piece"
---

# Framework Integrations

SenseLab integrates with popular multi-agent frameworks so you can add persistent memory to your existing workflows.
