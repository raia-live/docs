...
Use this skill at the start of any session where AMFS MCP tools are connected. This skill covers the full session lifecycle: set identity, briefing, read/write, and commit outcome. Also use when storing decisions, retrieving past context, or when mentioning AMFS, agent memory, or persistent memory across sessions.
...
compatibility: "claude.ai, Claude Desktop — any surface with AMFS MCP connected"
---
