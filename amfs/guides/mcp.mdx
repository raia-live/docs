...
<Tip>
  Copy the ready-made snippet from your [SenseLab Dashboard → Agents page](https://amfs-login.sense-lab.ai). The **MCP Connection Card** has your URL and key pre-filled.
</Tip>
