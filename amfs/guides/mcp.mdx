...
<Note>
  The install script sets this up for you on Claude Code and writes an
  equivalent guide into `~/.claude/CLAUDE.md` and `~/.codex/AGENTS.md`. Copy it
  in by hand for other clients.
</Note>
