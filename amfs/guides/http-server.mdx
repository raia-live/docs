---
title: "REST API"
description: "Access SenseLab over HTTP — entries, search, outcomes, traces, and real-time streaming."
icon: "server"
---

The SenseLab REST API gives you full access to agent memory from any language or service.
