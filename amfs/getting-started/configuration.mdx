...
|:---------|:------------|:---------|
| `AMFS_HTTP_URL` | Your SenseLab API URL — `https://amfs-login.sense-lab.ai` for SenseLab Cloud | Yes |
...
<Note>
  `AMFS_HTTP_URL` is the **API** host, not the dashboard. Cloud accounts point at
