...
[Hindsight](https://github.com/hindsight-ai/hindsight) maintains four separate memory networks (World, Experience, Opinion, Entity/Observation), with the separation fixed in the architecture rather than derived from how the memory is used.
...
[Cognee](https://cognee.ai) builds knowledge graphs from documents using LLM-powered extraction.
...
SenseLab is for production multi-agent systems that need versioning, feedback, and collaboration — the things a flat file cannot give you once more than one agent is writing.
